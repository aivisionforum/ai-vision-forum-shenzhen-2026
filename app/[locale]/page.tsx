...
const copy = {
  en: {
    ...
    intro: "Two separate one-day forums, each with its own topics and attendees. Choose the forum that fits your work—or join both.",
    primaryCta: "Explore forums",
    ...
    facts: "Forum facts",
    splitKicker: "TWO ONE-DAY FORUMS",
    splitTitle: "Two separate one-day forums. Four focused topics.",
    splitIntro:
      "Each date has its own topics and attendees. Choose the forum—or both—that you plan to attend.",
    explore: "Explore this forum",
    workingThemes: "Working themes",
    topicDetails: "Open brief",
    closeDetails: "Close topic brief",
    fullProgram: "Open both forum programs",
    scheduleKicker: "PROGRAM HIGHLIGHTS",
    scheduleTitle: "Programs for two one-day forums.",
    scheduleIntro:
      "Each forum has its own schedule, topics, and attendees. Review both, then choose the one—or both—you plan to attend.",
    viewDay: "Forum details",
    ...
    venueTitle: "Both one-day forums take place in Zhuhai.",
  ...
  "zh-cn": {
    ...
    heroTitle: "构建人机协同新范式",
    intro: "活动由两场独立的一日论坛组成，每场设置不同议题与参会嘉宾；可选择参加其中一场或两场。",
    primaryCta: "查看论坛",
    secondaryCta: "查看日程",
    dateLabel: "日期",
    placeLabel: "地点",
    ...
    facts: "论坛信息",
    splitKicker: "两场一日论坛",
    splitTitle: "两场独立的一日论坛，四个聚焦议题。",
    splitIntro: "每个日期都有独立的议题和参会嘉宾；请选择计划参加的一场，也可两场都参加。",
    explore: "查看本场论坛",
    workingThemes: "工作专题",
    topicDetails: "查看详情",
    closeDetails: "关闭专题详情",
    fullProgram: "查看两场论坛议程",
    scheduleKicker: "议程重点",
    scheduleTitle: "两场一日论坛议程",
    scheduleIntro: "每场论坛均有独立的日程、议题与参会嘉宾；请查看两场安排，并选择计划参加的一场或两场。",
    viewDay: "论坛详情",
    pastKicker: "论坛脉络",
        ...
        <div className="mx-auto max-w-[1320px]">
          <div>
            <div>
              ...
              <p className="mt-4 max-w-3xl text-base leading-relaxed text-muted-foreground">{c.splitIntro}</p>
            </div>
          </div>
