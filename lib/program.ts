...
export const PROGRAM_DAYS: ProgramDayContent[] = [
  {
    ...
    audience: { en: "OPEN SOURCE FORUM · THE OPEN COMMONS", "zh-cn": "开源论坛 · 开放共同体" },
    shortName: { en: "Open Source Forum", "zh-cn": "开源论坛" },
    title: {
    ...
    schedule: [
      ...
      { time: "16:00–17:00", title: { en: "Report-backs & Enterprise Forum preview", "zh-cn": "成果汇报与企业论坛预告" } },
  ...
  },
  {
    ...
    audience: { en: "ENTERPRISE FORUM · THE ENTERPRISE", "zh-cn": "企业论坛 · 企业变革" },
    shortName: { en: "Enterprise Forum", "zh-cn": "企业论坛" },
    title: {
