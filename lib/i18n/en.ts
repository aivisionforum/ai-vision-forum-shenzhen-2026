...
export const en: Translations = {
  ...
  scheduleSection: {
    ...
    items: [
      ...
      { time: "Oct 14 \u00b7 16:00\u201317:00", title: "Report-backs & Enterprise Forum preview" },
  ...
  venue: {
    ...
    colocatedDescription: "After the Enterprise Forum closes on October 15, the organizers will provide coach transport from Zhuhai directly to the GOSIM Shenzhen 2026 venue.",
