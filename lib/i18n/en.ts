...
export const en: Translations = {
  ...
  scheduleSection: {
    ...
    items: [
      ...
      { time: "Oct 14 \u00b7 10:00\u201311:15", title: "Panel: Open source in the agent era", subtitle: "Forges, foundations, communities", format: "Panel" },
      { time: "Oct 14 \u00b7 11:45\u201313:00", title: "Working session: trustworthy open source when agents write the code", format: "Facilitated working session" },
      { time: "Oct 14 \u00b7 13:00\u201314:00", title: "Lunch" },
      { time: "Oct 14 \u00b7 14:00\u201315:15", title: "Mobile Agentic Linux", subtitle: "A neutral Linux base for the agentic mobile era", format: "Keynote + Panel" },
      { time: "Oct 14 \u00b7 15:45\u201317:00", title: "Working session: aligning distros and communities on a shared mobile base", format: "Facilitated roundtable" },
      { time: "Oct 14 \u00b7 17:00\u201317:30", title: "Report-backs & Day 2 preview" },
