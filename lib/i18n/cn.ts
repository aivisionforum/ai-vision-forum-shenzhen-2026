...
export const cn: Translations = {
  ...
  scheduleSection: {
    ...
    items: [
      ...
      { time: "10月14日 · 10:00–11:15", title: "圆桌：智能体时代的开源", subtitle: "托管平台、基金会与社区", format: "圆桌" },
      { time: "10月14日 · 11:45–13:00", title: "工作会议：当智能体编写代码时，开源如何保持可信", format: "主持式工作会议" },
      { time: "10月14日 · 13:00–14:00", title: "午餐" },
      { time: "10月14日 · 14:00–15:15", title: "Mobile Agentic Linux（移动智能体 Linux）", subtitle: "面向智能体移动时代的中立 Linux 底座", format: "主旨 + 圆桌" },
      { time: "10月14日 · 15:45–17:00", title: "工作会议：发行版与社区如何对齐共享移动底座", format: "主持式圆桌" },
