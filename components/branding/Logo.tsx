...
export function Logo({ variant = "full", className = "" }: LogoProps) {
  if (variant === "compact") {
    return (
      <Link href="/" className={`relative top-[3px] inline-flex items-center gap-3 ${className}`} aria-label="AI Vision Forum Shenzhen 2026 home">
  ...
  return (
    <Link href="/" className={`inline-flex flex-col ${className}`} aria-label="AI Vision Forum Shenzhen 2026 home">
